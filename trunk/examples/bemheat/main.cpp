...
void solve1()
{
    ...
    aPosGmsh.save(Tn, "bem_heat1.pos", "heat");
...
void solve2()
{
    ...
    aPosGmsh.save(Ti, "bem_heat2.pos", "heat");
...
void solve3()
{
    ...
    aHexahedron.addVertex(aVertex01);
    aHexahedron.addVertex(aVertex02);
    aHexahedron.addVertex(aVertex03);
    aHexahedron.addVertex(aVertex04);
    aHexahedron.addVertex(aVertex05);
    aHexahedron.addVertex(aVertex06);
    aHexahedron.addVertex(aVertex07);
    aHexahedron.addVertex(aVertex08);

    CMshBasicMesher<double> aBasicMesher;

    aBasicMesher.generate(aHexahedron, 12, 6, 6, true);

    CMshMesh<double> aMesh1 = aBasicMesher.mesh();

    CGeoCoordinate<double> aVertex09(0.1, 0.1, 0.4);
    CGeoCoordinate<double> aVertex10(0.9, 0.1, 0.4);
    CGeoCoordinate<double> aVertex11(0.9, 0.4, 0.4);
    CGeoCoordinate<double> aVertex12(0.1, 0.4, 0.4);

    CGeoQuadrilateral<double> aQuadrilateral;

    aQuadrilateral.addVertex(aVertex09);
    aQuadrilateral.addVertex(aVertex10);
    aQuadrilateral.addVertex(aVertex11);
    aQuadrilateral.addVertex(aVertex12);

    aBasicMesher.generate(aQuadrilateral, 11, 5, true);
    ...
    aPosGmsh.save(Ti, "bem_heat3.pos", "heat");
