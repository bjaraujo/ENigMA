...
TEST_F(CTestPdeEquation, femSteadyLaplaceLine)
{
    ...
    EXPECT_NEAR(0.00, T.u(0), 1E-2);
    EXPECT_NEAR(0.33, T.u(1), 1E-2);
    EXPECT_NEAR(0.66, T.u(2), 1E-2);
    EXPECT_NEAR(1.00, T.u(3), 1E-2);
...
TEST_F(CTestPdeEquation, fvmSteadyLaplaceLine)
{
    ...
    CGeoCoordinate<decimal> aVertex1(+0.00, -0.05, -0.05);
    CGeoCoordinate<decimal> aVertex2(+1.00, -0.05, -0.05);
    CGeoCoordinate<decimal> aVertex3(+1.00, +0.05, -0.05);
    CGeoCoordinate<decimal> aVertex4(+0.00, +0.05, -0.05);
    CGeoCoordinate<decimal> aVertex5(+0.00, -0.05, +0.05);
    CGeoCoordinate<decimal> aVertex6(+1.00, -0.05, +0.05);
    CGeoCoordinate<decimal> aVertex7(+1.00, +0.05, +0.05);
    CGeoCoordinate<decimal> aVertex8(+0.00, +0.05, +0.05);
    ...
    EXPECT_NEAR(1.0/6.0, T.u(0), 1E-2);
    EXPECT_NEAR(1.0/2.0, T.u(1), 1E-2);
    EXPECT_NEAR(5.0/6.0, T.u(2), 1E-2);
...
TEST_F(CTestPdeEquation, bemSteadyLaplaceBox)
{
    ...
    EXPECT_NEAR(0.00, T.u(1), 0.2);
    EXPECT_NEAR(0.00, T.u(3), 0.2);
    EXPECT_NEAR(1.00, T.u(14), 0.2);
    EXPECT_NEAR(1.00, T.u(15), 0.2);
