...
class CTestSphSpiky : public ::testing::Test {
protected:
...
TEST_F(DISABLED_CTestSphSpiky, gradient1)
{
...
TEST_F(DISABLED_CTestSphSpiky, gradient2)
{
...
TEST_F(DISABLED_CTestSphSpiky, laplacian)
{
