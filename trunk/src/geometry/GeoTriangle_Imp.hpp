    ...
    namespace geometry
    {
        ...
        bool CGeoTriangle<Real>::intersects(CGeoTriangle<Real>& aTriangle, CGeoIntersectionType& anIntersectionType, const Real aTolerance)
        {
            ...
            try
            {
                ...
                if ((s1[0] > +aTolerance && s1[1] > +aTolerance && s1[2] > +aTolerance) ||
                    (s1[0] < -aTolerance && s1[1] < -aTolerance && s1[2] < -aTolerance))
                {
                    return false;
                }
                ...
                if ((s2[0] > +aTolerance && s2[1] > +aTolerance && s2[2] > +aTolerance) ||
                    (s2[0] < -aTolerance && s2[1] < -aTolerance && s2[2] < -aTolerance))
                {
                    return false;
                }
                ...
                if ((this->contains(aTriangle.vertex(0), aPointIntersectionType, aTolerance) &&
                    this->contains(aTriangle.vertex(1), aPointIntersectionType, aTolerance) &&
                    this->contains(aTriangle.vertex(2), aPointIntersectionType, aTolerance)) ||
                    (aTriangle.contains(this->vertex(0), aPointIntersectionType, aTolerance) &&
                    aTriangle.contains(this->vertex(1), aPointIntersectionType, aTolerance) &&
                    aTriangle.contains(this->vertex(2), aPointIntersectionType, aTolerance)))
                {
                    anIntersectionType = IT_INTERNAL;
                    return true;
                }
